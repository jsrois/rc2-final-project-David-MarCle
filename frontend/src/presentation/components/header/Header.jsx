    ...
    <header>
      <div className="headerContainer">
        ...
        <nav className="headerContainer__nav">
          ...
          <a className="headerContainer__nav--link" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-speakerphone" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1" stroke="#cb002b" fill="none" strokeLinecap="round" strokeLinejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        <div className="headerContainer__user">
          <a href="#" onClick={handleOpenUserModal}>
            <svg xmlns="http://www.w3.org/2000/svg" className="user icon icon-tabler icon-tabler-user-circle" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#cb002b" fill="none" strokeLinecap="round" strokeLinejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
          ...
          <button className="headContainer__user--button" onClick={handleOpenLogModal}>Sign up</button>
          <ModalLog isOpen={isLogModalOpen} onClose={handleCloseLogModal} />
          <ModalUser isOpen={isUserModalOpen} onClose={handleCloseUserModal} />
        </div>
      </div>
    </header>
  );
