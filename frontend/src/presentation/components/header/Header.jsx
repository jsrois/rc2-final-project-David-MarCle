 ...
 <div className="headerContainer">
    ...
    <nav className="headerContainer__nav">
        ...
        <div className="headerContainer__user">
            ...
            <a href=""><svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-user-circle" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#cb002b" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  <section className="portada">
            ...
            <div className="xxx">
                <h1>La nueva red para jóvenes profesionales del séptimo arte</h1>
                <p>Donde poder promocionarte, dar a conocer tus proyectos, conectar con otros profesionales y contactar con partners</p>
            <button>Empieza a conectar</button>
            </div>
            </section>
